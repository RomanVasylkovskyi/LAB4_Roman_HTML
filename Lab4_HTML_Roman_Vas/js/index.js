...
$notes_area.addEventListener('input', function (e) {
    if (e.target.classList.contains('BlockBody')) {
...
function noteGen(info) {
    ...
    for (let i = 0; i < info.length; i++) {
        temp += '<div class="note" style="left: ' + info[i].x + 'px; top: ' + info[i].y + 'px;" data-index="' + i + '"><textarea class="BlockBody"cols="3" rows="10" placeholder="Text////">' + info[i].text + '</textarea> </div>'
    }
